...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of JJCategoryKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/JasonJJJ/JJCategoryKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'JasonJJJ' => 'anhuijhy@163.com' }
  s.source           = { :git => 'https://github.com/JasonJJJ/JJCategoryKit.git', :tag => s.version.to_s }
